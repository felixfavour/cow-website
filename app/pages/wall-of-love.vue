    ...
    <div class="inner py-[10%] md:py-[5%]">
      ...
      >
        ...
        <h1 class="text-5xl md:text-5xl lg:text-6xl 2xl:text-7xl font-bold">
          Hear what others are <span class="emphasis-text">saying</span> about
          Cloud of Worship.
        </h1>
      </div>
      <div class="actions mt-[10%] md:mt-[5%] text-center">
        <a
          :href="mergeUtmsIntoUrl('https://app.cloudofworship.com/signup?utm_source=marketing_website&utm_medium=wall_of_love')"
...
useSeoMeta({
  ...
  ogTitle: "Wall of Love - Cloud of Worship",
  description:
