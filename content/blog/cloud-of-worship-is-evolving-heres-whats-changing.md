---
title: "Cloud of Worship is Evolving: Here’s What You Need to Know"
author: Kiitan Jones
...
paragraph: At Cloud of Worship, our mission has always been simple; to help churches focus on worship, not technology. As over 2,129+ churches trooped in and joined the platform, we listened closely to what worked, what slowed teams down, and where technology quietly became a burden. That feedback shaped every improvement we’ve made so far.
tag: Guides
---

At Cloud of Worship, our mission has always been simple: **to help churches focus on worship, not technology**.

As more churches joined the platform, we listened closely to what worked, what slowed teams down, and where technology quietly became a burden. That feedback shaped every improvement we’ve made so far.

To keep building a **hitch-free, reliable, and intuitive worship platform**, Cloud of Worship is moving to a **paid plan**. This step allows us to invest deeper into performance, offline reliability, collaboration, and long-term support, so every church, regardless of size, can lead worship with confidence.

To make this transition easy, **every user gets 1 month of upgraded access for free**, so you can experience the full power of Cloud of Worship before deciding.

## **What Remains Free (And Always Will)**

We believe core worship tools should always be accessible. That’s why the essentials remain available on the Free plan:

- Display the Bible with **full offline access**
- **1,000+ hymns available offline**
...
- Slide transitions, verse transitions, and styling
- Light & dark mode
- Real-time sync and auto-cloud backup
- Community access, updates, and customer support
...
- Add **images, audio files, and videos**
- Play **local and external videos** (YouTube & Vimeo)
...
- Quick actions to access everything in one place
...
- Services run without stress
- Teams collaborate without friction
- Churches grow without outgrowing their tools
