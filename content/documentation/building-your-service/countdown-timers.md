...
![Countdown configuration](/images/docs/11-add-countdown-timer.webp)

1. Pick a **Countdown duration**, or set **hours : minutes : seconds** precisely.
2. Optionally add **text above your countdown**.
